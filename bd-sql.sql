...
INSERT INTO `blog` (`id_blog`, `título_blog`, `texto_blog`, `data_blog`, `nome_img_blog`, `id_cont`) VALUES
	...
	(3, 'Novo Design', 'O site do PandoraBox está mudando para melhor. O site agora será adaptado a seu celular, para você poder acompanhar as atualizações do nosso site em qualquer hora e local!', '2022-11-07', 'blog-01.jpg', 4);
